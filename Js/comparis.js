...
function displayAddedItems() {
    ...
    let columnNames = ["Изображение", "Название процессора", "Производитель", "Дата выхода", "Архитектура", "Техпроцесс", "Количество ядер", "Количество потоков", "Частота", "Встроенный видеоускоритель", "Энергопотребление", "Цена"];
    ...
    addedItems.forEach((item, index) => {
        ...
        let deleteButton = document.createElement("buttondel");
